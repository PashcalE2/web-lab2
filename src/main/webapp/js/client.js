...
function setXFromInput(element) {
...
function setRFromInput(element) {
...
function onSubmitForm() {
	...
	if (send_button.attr("disabled") === true) {
		return;
	}
	...
	$.ajax({
		...
		success: function (data) {
			...
			setXFromInput(last_x_checkbox);
			setYFromInput();
			setRFromInput(last_radius_button);
		},
